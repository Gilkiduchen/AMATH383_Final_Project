...
4. Are the data-driven explanations of seizure prediction stable across feature-selection and explanation methods, as measured by a Consistency Index?
...
I expect the ODE model to show a threshold-like transition as excitability increases. Near the transition, the model should show either loss of stability of a normal equilibrium or emergence of a high-activity state. In the EEG features, I expect seizure-near windows to show changes in features related to spectral power, signal complexity, and line length. I also expect that CI will be higher for a small group of core features than for the full feature ranking, meaning explanation methods may disagree globally while still agreeing on important seizure-related drivers.
