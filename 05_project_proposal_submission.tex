...
\title{\textbf{Seizure Onset as a Dynamical Transition: ODE Bifurcation Modeling with Explainable ML Reliability Checks}}
\author{Yuming Chen}
\date{AMATH 383 Project Proposal}
...
\section*{Brief Description of Proposed Methods}
...
\section*{Potential Implications and Limitations}
...
\bibitem{chang2026}
Chang, C.-C., Chen, Y., and Chen, C.-Y. (2026).
Towards decision-ready explainable machine learning for water quality management using a consistency index and cross-validated feature-selection framework.
\textit{Environmental Research}, 297, 124207.
\url{https://doi.org/10.1016/j.envres.2026.124207}

\bibitem{guttag2010}
Guttag, J. (2010).
\textit{CHB-MIT Scalp EEG Database}.
PhysioNet.
\url{https://doi.org/10.13026/C2K01R}

\bibitem{jirsa2014}
Jirsa, V. K., Stacey, W. C., Quilichini, P. P., Ivanov, A. I., and Bernard, C. (2014).
On the nature of seizure dynamics.
\textit{Brain}, 137(8), 2210--2230.
\url{https://doi.org/10.1093/brain/awu133}

\bibitem{meijer2015}
Meijer, H. G. E., Eissa, T. L., Kiewiet, B., Neuman, J. F., Schevon, C. A., Emerson, R. G., Goodman, R. R., McKhann, G. M., Marcuccilli, C. J., Tryba, A. K., Cowan, J. D., van Gils, S. A., and van Drongelen, W. (2015).
Modeling focal epileptic activity in the Wilson-Cowan model with depolarization block.
\textit{Journal of Mathematical Neuroscience}, 5, 7.
\url{https://doi.org/10.1186/s13408-015-0019-4}

\bibitem{shoeb2010}
Shoeb, A. H., and Guttag, J. V. (2010).
Application of machine learning to epileptic seizure detection.
In \textit{Proceedings of the 27th International Conference on Machine Learning}.
\url{https://physionet.org/physiobank/database/chbmit/shoeb-icml-2010.pdf}
